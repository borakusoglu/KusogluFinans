...
export default function Dashboard({ user, setUser }) {
  ...
  const handleLogout = async () => {
    // Her çıkışta bugünün cache'ıni kaydet
  ...
  return (
    <div style={{display: 'flex', flexDirection: 'column', height: '100vh', background: 'linear-gradient(to bottom right, #f9fafb, #f1f5f9)', minWidth: '1200px', overflow: 'hidden', maxHeight: '100vh'}}>
      <header style={{background: 'white', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1)', borderBottom: '1px solid #e5e7eb', minWidth: '1200px'}}>
        <div style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 24px', minWidth: '1200px'}}>
          ...
          <nav style={{display: 'flex', gap: '8px', minWidth: '800px'}}>
            <Link to="/ajanda" style={{display: 'flex', alignItems: 'center', gap: '6px', padding: '10px 18px', color: '#374151', borderRadius: '12px', transition: 'all 0.2s', boxShadow: '0 1px 2px 0 rgba(0, 0, 0, 0.05)', textDecoration: 'none', width: '120px'}}>
          ...
          <div style={{display: 'flex', alignItems: 'center', gap: '12px', width: '280px', justifyContent: 'flex-end'}}>
            ...
            <Link to="/" style={{padding: '8px', color: '#6b7280', borderRadius: '12px', transition: 'all 0.2s', border: 'none', background: 'transparent', cursor: 'pointer', textDecoration: 'none', display: 'flex', position: 'relative'}} title="Hatırlatmalar">
            ...
            <div style={{width: '36px', height: '36px', background: 'linear-gradient(to bottom right, #2563eb, #9333ea)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontWeight: 'bold', fontSize: '16px', boxShadow: '0 10px 15px -3px rgba(0, 0, 0, 0.1)', flexShrink: 0}}>
      ...
      <main style={{flex: 1, overflow: 'auto'}}>
        <div style={{width: '100%', height: '100%', overflow: 'hidden'}}>
          <Routes>
            <Route path="/" element={<Hatirlatmalar user={user} />} />
            <Route path="/ajanda" element={<Ajanda user={user} />} />
      ...
      <WhatsNewModal />
      <ReminderWidget 
        isOpen={showReminderWidget} 
        onToggle={() => setShowReminderWidget(!showReminderWidget)} 
      />
      {showMessageAlert && (

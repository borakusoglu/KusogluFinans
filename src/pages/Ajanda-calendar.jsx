    <div style={{height: '100%', background: 'linear-gradient(to bottom right, #f9fafb, #dbeafe)', padding: '32px', overflowY: 'auto', animation: 'pageFadeIn 0.3s ease-out'}}>
      <div style={{maxWidth: '1400px', margin: '0 auto'}}>
        <div style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '24px'}}>
          <h1 style={{fontSize: '36px', fontWeight: 'bold', color: '#111827'}}>Ajanda</h1>
          {canEdit && (
            <button
              onClick={() => {
              ...
              style={{padding: '12px 24px', background: 'linear-gradient(to right, #10b981, #059669)', color: 'white', borderRadius: '8px', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px', fontWeight: 600, boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1)'}}
            >
        ...
        <div style={{background: 'white', borderRadius: '12px', boxShadow: '0 10px 15px -3px rgba(0, 0, 0, 0.1)', padding: '24px', marginBottom: '24px'}}>
          <div style={{display: 'grid', gridTemplateColumns: '1fr 200px 200px', gap: '16px', marginBottom: '16px'}}>
            <div className="relative">
              <input
                type="text"
                value={searchTerm}
                onChange={(e) => setSearchTerm(e.target.value)}
                placeholder="Açıklama veya tutar ara..."
          ...
          <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '16px', background: 'linear-gradient(to right, #eff6ff, #dbeafe)', borderRadius: '8px'}}>
            <div style={{fontSize: '14px', color: '#4b5563', fontWeight: 500}}>
              {filteredPayments.length} ödeme görüntüleniyor
            </div>
          ...
          <div style={{maxHeight: 'calc(100vh - 350px)', overflowY: 'auto'}}>
            <table style={{width: '100%', borderCollapse: 'collapse'}}>
              <thead style={{position: 'sticky', top: 0, background: '#f9fafb', zIndex: 10}}>
                <tr>
                  <th style={{padding: '16px', textAlign: 'left', fontSize: '13px', fontWeight: 600, color: '#374151', borderBottom: '2px solid #e5e7eb'}}>Tarih</th>
                  <th style={{padding: '16px', textAlign: 'left', fontSize: '13px', fontWeight: 600, color: '#374151', borderBottom: '2px solid #e5e7eb'}}>Açıklama</th>
                  <th style={{padding: '16px', textAlign: 'left', fontSize: '13px', fontWeight: 600, color: '#374151', borderBottom: '2px solid #e5e7eb'}}>Tip</th>
                  <th style={{padding: '16px', textAlign: 'left', fontSize: '13px', fontWeight: 600, color: '#374151', borderBottom: '2px solid #e5e7eb'}}>Yöntem</th>
                  <th style={{padding: '16px', textAlign: 'right', fontSize: '13px', fontWeight: 600, color: '#374151', borderBottom: '2px solid #e5e7eb'}}>Tutar</th>
                </tr>
              </thead>
              <tbody>
                {filteredPayments.map((payment, idx) => {
                  ...
                  return (
                    <tr key={payment.id} style={{borderBottom: '1px solid #f3f4f6', cursor: 'pointer', transition: 'background 0.2s'}} className="hover:bg-gray-50" onClick={() => {
                      ...
                      <td style={{padding: '16px', fontSize: '14px'}}>
                        <span style={{padding: '4px 12px', borderRadius: '6px', fontSize: '12px', fontWeight: 600, background: payment.payment_type === 'kredi_karti' ? '#dbeafe' : payment.payment_type === 'cari' ? '#fef3c7' : '#e0e7ff', color: payment.payment_type === 'kredi_karti' ? '#1e40af' : payment.payment_type === 'cari' ? '#92400e' : '#4338ca'}}>
                          {payment.payment_type === 'kredi_karti' ? 'Kredi Kartı' : payment.payment_type === 'cari' ? 'Cari' : 'Serbest'}
                        </span>
                      </td>
                      <td style={{padding: '16px', fontSize: '14px'}}>
                        <span style={{padding: '4px 12px', borderRadius: '6px', fontSize: '12px', fontWeight: 600, background: '#f3f4f6', color: '#374151'}}>
                          {payment.payment_method === 'nakit' ? 'Nakit' : payment.payment_method === 'dbs' ? 'DBS' : payment.payment_method === 'havale' ? 'Havale' : 'Çek'}
                        </span>
                      </td>
                      <td style={{padding: '16px', fontSize: '16px', fontWeight: 600, color: '#dc2626', textAlign: 'right'}}>
